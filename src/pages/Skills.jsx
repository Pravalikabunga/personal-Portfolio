            ...
            {filteredCategories.map((key, index) => {
              ...
              return (
                <AnimatedSection key={key} delay={index * 80}>
                  <div className="glass rounded-3xl p-6 border border-white/20 dark:border-white/10 shadow-xl card-shine h-full">
                    {/* Category Header */}
                    <div className="flex items-center gap-3 mb-5">
                      ...
                      <div>
                        <h3 className="font-display font-bold text-base text-primary-500 dark:text-brand-light">{cat.label}</h3>
                        <p className="text-xs text-brand-dark dark:text-brand-light/40">{cat.skills.length} skills</p>
                      </div>
                    </div>
          ...
          <AnimatedSection delay={500}>
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                <div key={label} className="glass rounded-2xl p-5 border border-white/20 dark:border-white/10 shadow-lg text-center card-shine">
                  ...
                  <div className="text-xs text-brand-dark dark:text-brand-light/60 mt-0.5">{label}</div>
                </div>
              ))}
            </div>
          </AnimatedSection>
