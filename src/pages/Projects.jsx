        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projectsData.map((project, index) => (
              <AnimatedSection key={project.id} delay={index * 150}>
                <div className="glass rounded-3xl border border-white/20 shadow-xl card-shine overflow-hidden group flex flex-col h-full hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl hover:shadow-primary-500/20">
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    <h3 className="font-display font-bold text-xl text-primary-500 mb-2 group-hover:text-primary-600 transition-colors">
                      {project.title}
                    </h3>
                    <p className="text-brand-dark text-sm leading-relaxed mb-4 flex-1">
                      {project.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">
                      {project.tech.map((t) => (
                        <span
                          key={t}
                          className="px-2 py-0.5 rounded-md bg-brand-light/50 text-brand-dark text-xs font-medium"
                        >
                          {t}
                        </span>
                      ))}
                    ...
                    <div className="flex gap-3">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-primary-500/10 text-brand-dark hover:border-primary-500 hover:text-primary-500 transition-all duration-200 text-sm font-medium"
                      >
                        <Github size={14} />
                        Code
                      </a>
          ...
          <AnimatedSection delay={400}>
            <div className="mt-16 text-center">
              <div className="glass rounded-3xl p-8 border border-white/20 shadow-xl card-shine inline-block max-w-md w-full">
                <div className="w-14 h-14 mx-auto mb-4 rounded-2xl bg-primary-500 flex items-center justify-center text-white">
                  <Github size={24} className="text-white" />
                </div>
                <h3 className="font-display font-bold text-xl text-primary-500 mb-2">See More on GitHub</h3>
                <p className="text-brand-dark text-sm mb-4">All my projects and contributions are available on my GitHub profile.</p>
                <a
